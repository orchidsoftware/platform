...
Если у вас есть предложения по улучшению этого руководства, создайте новый [issue](https://github.com/orchidsoftware/platform/issues). 
При представлении ошибок в документации, пожалуйста, укажите главу и окружающий текст, чтобы указать на ошибку.


### Введение

ORCHID - это инструмент, который позволяет быстро разрабатывать веб-сайты и линейные бизнес-приложения.
