...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function getUri() {
      ...
      path = path === '' ? "/press/menu" : "/press/menu/".concat(path);
  ...
  _createClass(_default, [{
    ...
    value: function connect() {
      ...
      values.forEach(function (model) {
        $(select).append(new Option(model.text, model.id, true, true)).trigger('change');
      });
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function validateForm() {
      var formId = this.data.get('id') || this.element.id || document.getElementById('post-form');
...
__webpack_require__(/*! /Users/funtom48/www/platform/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/funtom48/www/platform/resources/sass/app.scss */"./resources/sass/app.scss");
