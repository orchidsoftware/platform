...
__webpack_require__(/*! nestable */ "./node_modules/nestable/jquery.nestable.js");
...
var map = {
	"./components/menu_controller.js": "./resources/js/controllers/components/menu_controller.js",
	...
	"./fields/relationship_controller.js": "./resources/js/controllers/fields/relationship_controller.js",
	...
	"./fields/tag_controller.js": "./resources/js/controllers/fields/tag_controller.js",
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function add2Dom(id) {
      $('.dd > .dd-list').append("<li class=\"dd-item dd3-item\" data-id=\"".concat(id, "\"> <div  class=\"dd-handle dd3-handle\">Drag</div><div  class=\"dd3-content\">").concat(this.labelTarget.value, "</div> <div  class=\"edit icon-pencil\"></div></li>"));
      $("li[data-id=".concat(id, "]")).data(this.getFormData());
      this.sort();
      this.clear();
      this.send();
    }
    ...
    value: function save() {
      ...
      $("li[data-id=".concat(this.id, "]")).data(this.getFormData());
      $("li[data-id=".concat(this.id, "] > .dd3-content")).html(this.labelTarget.value);
      this.clear();
      this.send();
    }
    /**
    ...
    value: function remove() {
      $("li[data-id=".concat(this.id, "]")).remove();
    ...
    value: function exist() {
      return Number.isInteger(this.id) && $("li[data-id=".concat(this.id, "]")).length > 0;
    }
    /**
     *
     * @param path
    ...
    value: function getUri() {
      ...
      return platform.prefix("/press/menu/".concat(path));
    }
    /**
     *
     * @param blocks
...
_defineProperty(_default, "targets", ["id", "label", "slug", "auth", "robot", "style", "target", "title"]);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return _default; });
/* harmony import */ var stimulus_flatpickr__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! stimulus-flatpickr */ "./node_modules/stimulus-flatpickr/dist/stimulus-flatpickr.js");
/* harmony import */ var stimulus_flatpickr__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(stimulus_flatpickr__WEBPACK_IMPORTED_MODULE_0__);
...
function (_Flatpickr) {
  ...
  return _default;
}(stimulus_flatpickr__WEBPACK_IMPORTED_MODULE_0___default.a);
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function connect() {
      ...
      this.cropper = new cropperjs__WEBPACK_IMPORTED_MODULE_1__["default"](cropPanel, {
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function connect() {
      ...
      var input = this.element.querySelector('input');
      var editor = new quill__WEBPACK_IMPORTED_MODULE_1___default.a("#".concat(selector), {
        theme: 'snow',
        modules: {
      ...
      editor.root.innerHTML = input.value; // save value
...
/***/ "./resources/js/controllers/fields/relationship_controller.js":
/*!********************************************************************!*\
  !*** ./resources/js/controllers/fields/relationship_controller.js ***!
  \********************************************************************/
/*! exports provided: default */
      ...
      setTimeout(function () {
        $(select).select2({
          ...
          templateResult: function templateResult(state) {
            ...
            return $("<span>".concat(state.text, "</span><span class=\"pull-right badge bg-info\">").concat(state.count, "</span>"));
          },
          ...
          ajax: {
            url: function url(params) {
              return platform.prefix("/systems/tags/".concat(params.term));
            },
            delay: 340,
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function addSortDataAtributes(dropname, name, file) {
      $("".concat(dropname, " .dz-preview:last-child")).attr('data-file-id', file.id).addClass('file-sort');
    ...
    value: function initDropZone() {
      ...
      new dropzone__WEBPACK_IMPORTED_MODULE_1___default.a(dropname, {
        ...
        init: function init() {
          ...
          this.on('addedfile', function (e) {
            ...
            editButton.addEventListener('click', function () {
              loadInfo(e.data);
              $("".concat(dropname, " .modal")).modal('show');
            });
    ...
    set: function set(data) {
      ...
      this[this.getAttachmentTargetKey('description')].value = data.description; //this[this.getAttachmentTargetKey('url')].value = data.url;
...
_defineProperty(_default, "targets", ["name", "original", "alt", "description", "url"]);
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function submitByForm(event) {
      ...
      var form = this.application.getControllerForElementAndIdentifier(document.getElementById(formId), 'layouts--form');
      form.submit(event);
      event.preventDefault();
      return false;
    }
    ...
    value: function submit(event) {
      ...
      event.preventDefault();
      setTimeout(function () {
        var formAction = _this.element.getAttribute("action");
    ...
    value: function validateForm() {
      ...
      var textValidation = this.element.getAttribute('data-text-validation');
...
/* harmony import */ var _platform__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../platform */ "./resources/js/platform.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function initialize() {
      ...
      window.platform = Object(_platform__WEBPACK_IMPORTED_MODULE_3__["default"])();
...
__webpack_require__(/*! /home/tabuna/ORCHID/developer/platform/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/tabuna/ORCHID/developer/platform/resources/sass/app.scss */"./resources/sass/app.scss");
