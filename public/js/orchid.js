...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function submit(event) {
      ...
      console.log(activeElementAction, 'test', document.querySelector(':focus'));
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function connect() {
      ...
      $(document).on('shown.bs.tab', 'a[data-toggle="tab"]', draw);
      document.addEventListener('turbolinks:before-render', function () {
        $(document).off('shown.bs.tab', 'a[data-toggle="tab"]', draw);
      });
    }
    /**
     *
