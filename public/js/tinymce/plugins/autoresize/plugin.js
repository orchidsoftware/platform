...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_3rx7y893jk26xiqt.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_3rx7y893jk26xiqt.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_3rx7y893jk26xiqt.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_3rx7y893jk26xiqt.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_3rx7y893jk26xiqt.getAutoResizeBottomMargin(editor);
    ...
    if ($_3rx7y893jk26xiqt.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_bh638y90jk26xiqp.resize(editor, oldSize);
    });
  };
  var $_dspxuf8zjk26xiqn = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_dspxuf8zjk26xiqn.register(editor, oldSize);
      $_bh638y90jk26xiqp.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
