...
jsc*/
            ...
            var getTrace = function () {
                ...
                if (err.stack !== undefined) {
                    ...
                    return Arr.find(lines, function (line) {
                        return line.indexOf('alloy') > 0 && !Arr.exists(path, function (p) {
  ...
  */
    ...
    define(
        ...
        function (Keys, NoState, Fields, KeyingType, AlloyLogger, ArrNavigation, KeyMatch, KeyRules, FieldSchema, Arr, Fun, Option, Compare, Focus, SelectorFilter, SelectorFind,
                  Height) {
            var schema = [
    ...
    define(
        ...
        function (Keys, KeyingState, Fields, KeyingType, KeyingTypes, DomMovement, DomPinpoint, KeyMatch, KeyRules, WrapArrNavigation, FieldSchema, Cell, Fun, Option, Focus,
                  SelectorFind) {
            var schema = [
    ...
    define(
        ...
        function (Keys, NoState, KeyingType, KeyingTypes, DomMovement, DomPinpoint, KeyMatch, KeyRules, MatrixNavigation, FieldSchema, Arr, Fun, Option, Focus, SelectorFilter,
                  SelectorFind) {
            var schema = [
    ...
    define(
        ...
        function (Behaviour, Focusing, Keying, AlloyEvents, NativeEvents, PartType, SliderActions, FieldSchema, Cell, Fun, Option, PlatformDetection) {
            ...
            var spectrumPart = PartType.required({
                schema: [
                    FieldSchema.state('mouseIsDown', function () {
                        return Cell(false);
                    })
                ],
                name: 'spectrum',
    ...
    define(
        ...
        function (FieldSchema, Cell, Fun, PlatformDetection) {
            ...
            return [
                ...
                FieldSchema.state('value', function (spec) {
    ...
    define(
        ...
        function (AddEventsBehaviour, Behaviour, Composing, Representing, Toggling, Memento, AlloyEvents,
    ...
    define(
        ...
        function (AddEventsBehaviour, Behaviour, Disabling, Highlighting, Keying, Receiving, Representing, Memento, AlloyEvents, AlloyTriggers, NativeEvents, Button, Container,
        ...
        function (ObjIndex, DomModification, Objects, Arr, Obj, Merger, Json, Fun, Result) {
            ...
            var onlyOne = function (chain, aspect, order) {
                if (chain.length > 1) return Result.error(
                    ...
                    Json.stringify(Arr.map(chain, function (b) {
                        return b.name();
                    })) + '. At this stage, this ' +
     ...
     */
            ...
            var missingOrderError = function (eventName, tuples) {
                return new Result.error([
                    ...
                    'can trigger it are: ' + Json.stringify(Arr.map(tuples, function (c) {
                        return c.name();
                    }), null, 2)
                ]);
            };
            ...
            var fuse = function (tuples, eventOrder, eventName) {
                ...
                if (!order) return missingOrderError(eventName, tuples);
                    ...
                    var handlers = Arr.map(sortedTuples, function (tuple) {
                ...
                var r = Obj.mapToArray(byEventName, function (tuples, eventName) {
                    ...
                    return combined.map(function (handler) {
                        ...
                        var purpose = tuples.length > 1 ? Arr.filter(eventOrder, function (o) {
                            return Arr.contains(tuples, function (t) {
                                return t.name() === o;
                            });
                        }).join(' > ') : tuples[0].name();
        ...
        function (Fields, DomDefinition, DomModification, AlloyTags, FieldPresence, FieldSchema, Objects, ValueSchema, Arr, Fun, Merger, Error) {
            ...
            var toDefinition = function (info) {
                var base = {
                    ...
                    domChildren: Arr.map(info.components(), function (comp) {
                        return comp.element();
                    })
                };

                return DomDefinition.nu(Merger.deepMerge(base,
                    info.dom().innerHtml().map(function (h) {
                        return Objects.wrap('innerHtml', h);
                    }).getOr({}),
                    info.dom().value().map(function (h) {
                        return Objects.wrap('value', h);
                    }).getOr({})
                ));
            };
    ...
    define(
        ...
        function (CompBehaviours, ComponentApi, NoContextApi, GuiTypes, BehaviourBlob, ComponentDom, ComponentEvents, CustomDefinition, DomModification, DomRender, ValueSchema,
    ...
    define(
        ...
        function (Component, ComponentApi, NoContextApi, GuiTypes, DefaultEvents, Tagger, CustomSpec, FieldSchema, Objects, ValueSchema, Arr, Cell, Fun, Merger, Option, Result,
                  Element, Error) {
    ...
    define(
        ...
        function (EditableFields, Behaviour, Focusing, Keying, Representing, AlloyEvents, NativeEvents, SystemEvents, Fields, WidgetParts, ItemEvents, AlloyParts, FieldSchema,
                  Merger, Option) {
            var builder = function (info) {
    ...
    define(
        ...
        function (EditableFields, Behaviour, Composing, Highlighting, Keying, Replacing, Representing, GuiFactory, AlloyEvents, AlloyTriggers, SystemEvents, FocusManagers,
    ...
    define(
        ...
        function (AddEventsBehaviour, Behaviour, Representing, Toggling, Transitioning, GuiFactory, Memento,
            ...
            var convert = function (formats, memMenuThunk) {
                var mainMenu = makeMenu('Styles', [].concat(
    ...
    define(
        ...
        function (Behaviour, Receiving, Toggling, Memento, Objects, Arr, Fun, Option, Type, setTimeout, window, Receivers, TinyChannels, Styles, Buttons, ColorSlider, FontSizeSlider,
    ...
    */
    ...
    define(
        ...
        function (AddEventsBehaviour, Behaviour, Keying, Toggling, GuiFactory, AlloyEvents, Container, Toolbar, ToolbarGroup, Arr, Cell, Fun, Css, Scrollables, Styles, Scrollable,
                  UiDomFactory) {
            return function () {
    ...
    define(
        ...
        function (Behaviour, Replacing, Swapping, GuiFactory, Button, Container, Fun, Class, Styles,
                  UiDomFactory) {
    ...
    define(
        ...
        function (GuiFactory, SystemEvents, Attachment, SystemApi, Container, Debugging, DescribedHandler, GuiEvents, Triggers, AlloyLogger, Registry, Tagger, Arr, Fun, Result,
    ...
    */
    ...
    define(
        ...
        function (Fun, Option, Throttler, Focus, DomEvent, Body, Element, Css, clearInterval, clearTimeout, console, Math, parseInt, setInterval, setTimeout, FakeSelection,
    ...
    define(
        ...
        function (Fun, Singleton, Struct, Focus, Element, Class, Css, document, IosEvents, IosSetup,
    ...
    define(
        ...
        function (Swapping, AlloyTriggers, Attachment, Debugging, Cell, Fun, PlatformDetection, Focus, Insert, Element, Node, DOMUtils, ThemeManager, TinyCodeDupe, TinyChannels,
