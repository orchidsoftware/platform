...
### Fixed
- Fixed crash when rendering validation errors on Laravel 12.55.1 due to incorrect handling of ViewErrorBag in fields [#3082](https://github.com/orchidsoftware/platform/issues/3082)

## 14.52.5 - 2025-11-02

### Fixed

- Avoid invalid image request in Firefox
