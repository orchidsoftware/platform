                    ...
                    <div class="row px-2">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{__('Campaign Source')}} - <span
                                        class="font-weight-bold">utm_source</span></label>
                            ...
                            <div class="form-group">
                                <label>{{__('Campaign medium')}} - <span
                                        class="font-weight-bold">utm_medium</span></label>
                                <input type="text" data-utm-target="medium" placeholder="cpc"
                                       class="form-control">
                                <small
                                    class="form-text text-muted w-b-k">{{__('Marketing medium: (e.g. cpc, ppc, banner, email)')}}</small>
                            </div>

                            <div class="form-group">
                                <label>{{__('Campaign name')}} - <span
                                        class="font-weight-bold">utm_campaign</span></label>
                                <input type="text" data-utm-target="campaign" pattern="[a-zA-Z0-9]+"
                                       placeholder="sleeping_beds"
                                       class="form-control">
                                <small
                                    class="form-text text-muted w-b-k">{{__('Product, promo code, or slogan (e.g. spring_sale)')}}</small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" data-utm-target="term" placeholder="Golf ball"
                                       class="form-control">
                                <small
                                    class="form-text text-muted w-b-k">{{__('Paid keywords: (e.g. running+shoes)')}}</small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" data-utm-target="content" placeholder="cpc"
                                       class="form-control">
                                <small
                                    class="form-text text-muted w-b-k">{{__('Ad-specific content used to differentiate ads')}}
                                </small>
                            </div>
                        </div>
