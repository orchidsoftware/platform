...
<div data-controller="upload" data-upload-storage="{{$storage ?? 'public'}}" data-upload-name="{{$name}}" data-upload-data="{!!htmlspecialchars(json_encode($value), ENT_QUOTES, 'UTF-8')!!}">
  <div class="dropzone">
    <div class="fallback">
              ...
              <div class="col-sm-10">
                <div class="wrapper">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" data-target="upload.attachment_name" readonly maxlength="255" placeholder="{{trans('dashboard::post/uploads.information.system_name')}}">
                  </div>
                  <div class="form-group">
                    <label>{{trans('dashboard::post/uploads.information.name')}}</label>
                    <input type="text" class="form-control" data-target="upload.attachment_original_name" maxlength="255" placeholder="{{trans('dashboard::post/uploads.information.name')}}">
                  </div>
                  <div class="form-group">
                    <label>{{trans('dashboard::post/uploads.information.alt')}}</label>
                    <input type="text" class="form-control" data-target="upload.attachment_alt" maxlength="255" placeholder="{{trans('dashboard::post/uploads.information.alt')}}">
                  </div>
                  <div class="form-group">
                    <label>{{trans('dashboard::post/uploads.information.description')}}</label>
                    <textarea class="form-control no-resize" data-target="upload.attachment_description" placeholder="{{trans('dashboard::post/uploads.information.description')}}"
                  ...
                  <p class="text-right">
                    ...
                    <button type="button " data-action="click->upload#save" class="btn btn-default ">{{trans('dashboard::common.apply')}}</button>
                  </p>
