@component($typeForm, get_defined_vars())
    <div data-controller="fields--cropper"
         ...
         @if($width) data-fields--cropper-width="{{ $width }}" @endif
         @if($height) data-fields--cropper-height="{{ $height }}" @endif
         @if($minWidth) data-fields--cropper-min-width="{{ $minWidth }}" @endif
         @if($minHeight) data-fields--cropper-min-height="{{ $minHeight }}" @endif
         @if($maxWidth) data-fields--cropper-max-width="{{ $maxWidth }}" @endif
         @if($maxHeight) data-fields--cropper-max-height="{{ $maxHeight }}" @endif
