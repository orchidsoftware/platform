<div class="wrapper-md">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">{{trans('dashboard::systems/category.parent')}}</label>
        <div class="col-sm-10">
    ...
    <div class="form-group m-t-md">
        <label class="col-sm-2 control-label">{{trans('dashboard::systems/category.slug')}}</label>
        <div class="col-sm-10">
