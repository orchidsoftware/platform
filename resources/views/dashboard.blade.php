...
@section('body-left')
    ...
    <div class="aside col-xs-12 col-md-2 bg-dark d-flex flex-column">
            ...
            <nav class="collapse w-100 d-md-flex flex-column" id="headerMenuCollapse">
                ...
                <div class="h-100 w-100 position-relative to-top cursor d-none d-md-block mt-md-5"
...
@section('body-right')
    ...
    <div class="workspace mt-3 mt-md-4">
        ...
        <div class="@hasSection('navbar') @else d-none d-md-block @endif layout d-flex align-items-center">
