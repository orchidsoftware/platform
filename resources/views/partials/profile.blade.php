<div class="profile-container d-flex align-items-stretch p-3 gap-3 justify-content-between rounded lh-sm position-relative overflow-hidden">

    <a href="{{ route(config('platform.profile', 'platform.profile')) }}" class="col-10 d-flex align-items-center">
