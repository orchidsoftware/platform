...
export default class extends ApplicationController {
    ...
    save() {
        ...
        let loadMediaModal = Modal.getOrCreateInstance(
            dropname.querySelector(`.attachment.modal`)
        );
    ...
    resortElement() {
        ...
        axios
            .post(
                this.prefix("/systems/files/sort"),
                {
                    files: items,
                },
                {
    ...
    initDropZone() {
        ...
        const removeButtonTemplate = this.element
            .querySelector("#" + this.data.get("id") + "-remove-button")
            .innerHTML.trim();
        const editButtonTemplate = this.element
            .querySelector("#" + this.data.get("id") + "-edit-button")
            .innerHTML.trim();
            ...
            this.element.querySelector("#" + this.data.get("id")),
            {
                ...
                init: function () {
                    this.on("addedfile", e => {
                        ...
                        const editButton =
                            Dropzone.createElement(editButtonTemplate);
                        const removeButton =
                            Dropzone.createElement(removeButtonTemplate);
                        ...
                        editButton.addEventListener("click", () => {
                            ...
                            const attachmentModal = Modal.getOrCreateInstance(
                                dropname.querySelector(`.attachment.modal`)
                            );
                    ...
                    this.on("removedfile", file => {
                        if (
                            ...
                            file.data.hasOwnProperty("id")
                        ) {
                            let removeItem = dropname.querySelector(
                                `.files-${file.data.id}`
                            );
                            if (
                                removeItem !== null &&
                                removeItem.parentNode !== null
                            ) {
    ...
    loadMedia() {
        ...
        let loadMediaModal = Modal.getOrCreateInstance(
            dropname.querySelector(`.media.modal`)
        );
        loadMediaModal.show();
        ...
        axios
            .post(
                this.prefix(`/systems/media?page=${this.page}`),
                {
                    filter,
                },
                {
            ...
            .then(response => {
                ...
                // show/hide load more
                this.loadmoreTarget.classList.toggle(
                    "d-none",
                    response.data.last_page === this.page
                );
                this.renderMedia();
            });
    }
    ...
    renderMedia() {
        this.mediaList.forEach((element, key) => {
            ...
            const template = this.element
                ...
                .content.querySelector(".media-item")
                .cloneNode(true);
