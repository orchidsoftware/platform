                ...
                <div class="panel-heading">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <button class="btn btn-link" type="button" data-toggle="collapse" data-parent="#tables-accordion" data-target="#table-{{$name}}" aria-expanded="false" aria-controls="table-{{$name}}">
                                Show Attributes
                            </button>
                        </div>
                    </div>
