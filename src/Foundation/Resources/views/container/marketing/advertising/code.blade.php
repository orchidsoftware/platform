                ...
                <div class="wrapper-md">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <label class="i-switch bg-info m-t-xs m-r">
                                    <input type="checkbox" name="options[locale][{{$code}}]" {{$adv->checkLanguage($code)  ? 'checked' : ''}} value="true">
                                    <i></i>
                                </label>
                        ...
                        <div class="col-md-12 code-block-wrapper">
                            ...
                            <input type="hidden" id="hidden-code-{{$code}}" value="{{$adv->getContent('code',$code)}}" name="content[{{$code}}][code]">
                        </div>
                    </div>
